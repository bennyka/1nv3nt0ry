...
// in simulator we redefine to format for Inventory Developer console
...
{\
	NSString * exceptionName = [@"org.inventory." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.inventory";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInventoryNativeItemNone = -1, 
	UIInventoryNativeItemSpinner = -2,
	UIInventoryNativeItemProgressBar = -3,
	
	UIInventoryNativeItemSlider = -4,
	UIInventoryNativeItemSwitch = -5,
	UIInventoryNativeItemMultiButton = -6,
	UIInventoryNativeItemSegmented = -7,
	
	UIInventoryNativeItemTextView = -8,
	UIInventoryNativeItemTextField = -9,
	UIInventoryNativeItemSearchBar = -10,
	
	UIInventoryNativeItemPicker = -11,
	UIInventoryNativeItemDatePicker = -12,
	
	UIInventoryNativeItemInfoLight = -13,
	UIInventoryNativeItemInfoDark = -14,
	
	UIInventoryNativeItemDisclosure = -15,
	
	UIInventoryNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Inventory instances of
